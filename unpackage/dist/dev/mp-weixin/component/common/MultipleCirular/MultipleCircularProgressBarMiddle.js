...
const _sfc_main = {
  __name: "MultipleCircularProgressBarMiddle",
  setup(__props) {
    const circleBigLeft = common_vendor.ref(null);
    const circleBigRight = common_vendor.ref(null);
    let timer = 0;
    let percent = 0;
    let num = 80;
    const step = () => {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-56a11648"], ["__file", "D:/\u65B0\u5EFA\u6587\u4EF6\u5939 (2)/\u8F6F\u4EF6\u5F00\u53D1/weighBookFontend/component/common/MultipleCirular/MultipleCircularProgressBarMiddle.vue"]]);
